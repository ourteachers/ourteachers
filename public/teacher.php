...
<html class="no-js" lang="">
    ...
    <div class="page-wrap">
      ...
      <div class="container">
        ...
        <!-- TEACHER AVATAR -->
        <div class="d--b clear center">
            <img class="avatar-xl center" src="https://s3.amazonaws.com/uifaces/faces/twitter/jsa/128.jpg">
        </div>

        <!-- NAME -->
        <div class="d--b center m--b">
            <h2>Evan Dennington</h2>
        </div>
        ...
        <div class="col-9 m--b">
          ...
          <span class="title">Parent Satisfaction</span>
          <div class="progress-bar blue stripes">
        ...
        <div class="col-12">
            ...
            <div class="teacher__meta-grouping">
              <div class="heading">Teacher Bio</div>
      ...
      <div class="main-content pad-width">

        <!-- SUMBIT A REVIEW BUTTON -->
        <div class="center">
          <a href="#" class="btn--secondary x-large m--b" style="margin-top:15px;">Submit a Review</a>
        </div>
